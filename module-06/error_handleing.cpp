...
int main()
{
    ...
    while (true)
    {
        cout << "Option 1 : Insert tail " << endl;               // done
        cout << "Option 2 : pirnt inserted value " << endl;       // done
        cout << "Option 3 : Inset any position & value " << endl; // done
        cout << "Option 4 : Insert New head  " << endl;           // done
        cout << "Option 5 : Delete postion  " << endl;            // done
